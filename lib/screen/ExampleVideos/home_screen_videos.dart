...
import 'package:multimedia01/screen/ExampleVideos/video_player_screen_04.dart';
import 'package:multimedia01/screen/ExampleVideos/video_player_screen_05.dart';
        ...
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              //--------------------------------------------------------------------------------
              // Ir al widget de Videos (VideoPlayerScreen04)
              //--------------------------------------------------------------------------------

              // Espacio vertical para separar elementos.
              const SizedBox(height: 20),

              // --- Botón de Videos 04 (Video Local) ---
              SizedBox(
                width: buttonWidth,
                child: ElevatedButton.icon(
                  icon: const Icon(Icons.folder),
                  label: const Text('Videos 04: Reproducir desde Assets', style: TextStyle(fontSize: 16)),
                  style: ElevatedButton.styleFrom(padding: const EdgeInsets.symmetric(vertical: 15)),
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const VideoPlayerScreen04()));
                  },
                ),
              ),

              //--------------------------------------------------------------------------------
              // Ir al widget de Videos (VideoPlayerScreen05)
              //--------------------------------------------------------------------------------

              // Espacio vertical para separar elementos.
              const SizedBox(height: 20),

              // --- Botón de Videos 05 (Video de Fondo) ---
              SizedBox(
                width: buttonWidth,
                child: ElevatedButton.icon(
                  icon: const Icon(Icons.videocam_off),
                  label: const Text('Videos 05: Video de Fondo (Background)', style: TextStyle(fontSize: 16)),
                  style: ElevatedButton.styleFrom(padding: const EdgeInsets.symmetric(vertical: 15)),
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const VideoPlayerScreen05()));
                  },
                ),
              ),
            ],
